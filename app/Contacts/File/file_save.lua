...
local function AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA()
...
local function lua_save(name,value,saved)
	...
	elseif type(value) == "function" and value == AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA then
		io.write(name," =  nil \n")
	else 
