...
local function get_section(szs,offset)
	...
	table.insert(outer,geo_.Point:new{x-szs[3]/2, y+szs[1]/2-szs[3]});
...
require"app.Steel.section".add_type("Z",get_section);

require"app.Steel.section".add_type("BLZ",get_section);
require"app.Steel.section".add_type("LZ",get_section);
